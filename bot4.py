...
madlibs = [
    ...
    "I would [LOVE] to [MEET] Porter. I could [TALK] to her about her [BACKGROUND], policies, and so much more. Regardless, I [SUPPORT] Katie Porter."
    ]
...
replacements = {
    ...
    'LOVE' : ['love', 'be so happy'],
    'MEET' : ['meet', 'reach out to', 'see'],
    'TALK' : ['talk', 'converse', 'ask her about', 'learn more about'],
    'BACKGROUND' : ['background', 'upbringing', 'education'],
    'SUPPORT' : ['support', 'follow', 'back']
    }
...
# FIXME:
# connect to reddit 
reddit = praw.Reddit('botfour', user_agent='cs40') #connecting to reddit
