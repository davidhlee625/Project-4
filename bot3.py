...
# FIXME:
# connect to reddit 
reddit = praw.Reddit('botthree') #connecting to reddit

# FIXME:
# select a "home" submission in the /r/cs40_2022fall subreddit to post to,
# and put the url below
submission_url = 'https://www.reddit.com/r/cs40_2022fall/comments/z4fn5n/my_sister_just_gave_me_this/'
