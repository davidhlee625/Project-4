...
# FIXME:
# connect to reddit 
reddit = praw.Reddit('bottwo') #connecting to reddit

# FIXME:
# select a "home" submission in the /r/cs40_2022fall subreddit to post to,
# and put the url below
submission_url = 'https://www.reddit.com/r/cs40_2022fall/comments/z4fn99/im_the_worst/'
...
# if posted:
    ...
    for comment in all_comments:
        ...
        if str(comment.author) != 'augbot522':
